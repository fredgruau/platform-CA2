...
public final class RandCA implements CAloops {

    @Override
    public void theLoops(int[][] mem, PrShift p) {
        randBit(p, mem[0], mem[3], mem[4], mem[5], mem[6], mem[7], mem[8]);
        //fromE(p, mem[0], mem[3], mem[4], mem[5], mem[6], mem[7], mem[8]);
    ...
    public HashMap<String, List<Integer>> fieldOffset() {
        ...
        map.put("randvE", CAloops.list(new Integer(14), new Integer(15), new Integer(16), new Integer(17), new Integer(18), new Integer(19)));
        return (map);
    }
