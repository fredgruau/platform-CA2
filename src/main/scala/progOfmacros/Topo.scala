...
object Topo {
  /** From a booleV, computes the number of true connected components, likely to be reused for BlobE, BlobVe */
  ...
  /** produces a boolVe that takes into account what happens on the frontier of the chip: if there is a blob on the border, it says that there is a border */
