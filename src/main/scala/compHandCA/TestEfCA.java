...
import static compiledLoops.BasicMoves.ftoEf;
...
public final class TestEfCA implements CAloops {

    @Override
    public void theLoops(int[][] mem, PrShift p) {
        ftoEf(p, mem[0], mem[1], mem[14], mem[15], mem[16], mem[17], mem[18], mem[19]);
    }
    ...
    public HashMap<String, List<Integer>> fieldOffset() {
        ...
        map.put("llseed", CAloops.list(new Integer(0), new Integer(1)));
        ...
        map.put("fE", CAloops.list(new Integer(14), new Integer(15), new Integer(16), new Integer(17), new Integer(18), new Integer(19)));
        return (map);
    }
