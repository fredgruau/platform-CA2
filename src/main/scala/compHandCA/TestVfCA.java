...
import static compiledLoops.BasicMoves.ftoVf;
...
public final class TestVfCA implements CAloops {

    @Override
    public void theLoops(int[][] mem, PrShift p) {
        ftoVf(p, mem[0], mem[1], mem[14], mem[15], mem[16], mem[17], mem[18], mem[19]);
    }
